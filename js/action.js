...
(() => {
/*!*********************************!*\
  !*** ./dev/js/action/action.js ***!
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common_InputInsertTemplateText__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/InputInsertTemplateText */ "./dev/js/common/InputInsertTemplateText.js");
/* harmony import */ var _common_TemplateTextReplacer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/TemplateTextReplacer */ "./dev/js/common/TemplateTextReplacer.js");
...
(() => {
    ...
    const multipleAllDLBtnDef = multipleDLBtnWrap.querySelector(".def_all")
    const multipleAllDLBtnResize = multipleDLBtnWrap.querySelector(".resize_all")
    ...
    multipleAllDLBtnDef.addEventListener("click", () => {
        if (confirm("全ての画像を[ 元サイズ ]で一括ダウンロードしてよろしいですか？")) {
            let imageGroups = imagesField.querySelectorAll(".image-group");
            imageGroups.forEach((elem, index) => {
                originalDownload(imgBuff[elem.getAttribute("data-img")], index)
            })
    ...
    multipleAllDLBtnResize.addEventListener("click", () => {
        if (confirm("全ての画像を[ 指定サイズ ]でリサイズして一括ダウンロードしてよろしいですか？")) {
            let imageGroups = imagesField.querySelectorAll(".image-group");
            imageGroups.forEach((elem, index) => {
                resizeDownload(imgBuff[elem.getAttribute("data-img")], index)
            })
    ...
    function replaceTemplate(name, idx) {
        let r = new _common_TemplateTextReplacer__WEBPACK_IMPORTED_MODULE_1__.TemplateTextReplacer()
